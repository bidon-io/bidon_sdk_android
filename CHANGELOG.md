...
- [BDN-931](https://appodeal.atlassian.net/browse/BDN-931) Migrated to Android Gradle plugin 8
...
- [BDN-763](https://appodeal.atlassian.net/browse/BDN-763) Renamed Loss model `ecpm` field to `price`
